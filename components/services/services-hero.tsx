...
export function ServicesHero() {
  return (
    <section className="relative pt-32 pb-20 lg:pt-40 lg:pb-28 overflow-hidden">
      {/* Background gradient */}
      <div className="absolute inset-0 bg-gradient-to-br from-secondary via-secondary/90 to-accent/80" />
      ...
      <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 text-center">
        ...
        >
          ...
          <p className="text-xl lg:text-2xl text-white/80 max-w-3xl mx-auto leading-relaxed">
            Comprehensive multimedia production services tailored to bring your creative vision to life with precision and excellence.
          </p>
        </motion.div>
      </div>
    </section>
